...
class Circle
{
    public:                         // Accesss specifier
        ...
        void Display()              // Concrete method          // 1000  with body
        {
            cout<<"Value of radius is : "<<Radius<<"\n";
        }
        virtual float Area() = 0;           // Abstract method  // without body// last la 0 n start la virtual asel tr te abstract method aste.
